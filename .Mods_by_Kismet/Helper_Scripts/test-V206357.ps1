# Standalone Test for V-206357
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206357.ps1
...
Write-Host "Testing V-206357 standalone..." -ForegroundColor Cyan
