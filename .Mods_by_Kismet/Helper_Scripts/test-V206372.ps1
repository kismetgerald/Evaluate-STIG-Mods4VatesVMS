# Standalone Test for V-206372
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206372.ps1
...
Write-Host "Testing V-206372 standalone..." -ForegroundColor Cyan
