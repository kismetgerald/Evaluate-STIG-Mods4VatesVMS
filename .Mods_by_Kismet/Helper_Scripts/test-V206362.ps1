# test-V206362.ps1
# Test script for V-206362 (Event source identification)
# STIG Rule: SV-206362r961863_rule
# CAT II - Web server log entries must identify the source of events

$ErrorActionPreference = 'Stop'

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Testing V-206362: Event Source" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# Execute function
$startTime = Get-Date
Write-Host "Executing Get-V206362..." -ForegroundColor Yellow
$result = Get-V206362 @testParams
$endTime = Get-Date
