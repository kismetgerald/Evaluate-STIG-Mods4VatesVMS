# Standalone Test for V-264365
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V264365.ps1
...
Write-Host "Testing V-264365 standalone..." -ForegroundColor Cyan
