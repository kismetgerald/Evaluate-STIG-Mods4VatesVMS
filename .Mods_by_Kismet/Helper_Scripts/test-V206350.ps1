# Standalone Test for V-206350
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206350.ps1
...
Write-Host "Testing V-206350 standalone..." -ForegroundColor Cyan
