# Standalone Test for V-206383
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206383.ps1
...
Write-Host "Testing V-206383 standalone..." -ForegroundColor Cyan
