# Standalone Test for V-206375
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206375.ps1
...
Write-Host "Testing V-206375 standalone..." -ForegroundColor Cyan
