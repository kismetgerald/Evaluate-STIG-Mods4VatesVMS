# Standalone Test for V-206373
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206373.ps1
...
Write-Host "Testing V-206373 standalone..." -ForegroundColor Cyan
