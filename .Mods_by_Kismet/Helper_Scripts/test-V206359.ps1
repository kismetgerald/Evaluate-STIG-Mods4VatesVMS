# Standalone Test for V-206359
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206359.ps1
...
Write-Host "Testing V-206359 standalone..." -ForegroundColor Cyan
