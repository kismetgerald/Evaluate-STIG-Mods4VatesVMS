# Standalone Test for V-206366
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206366.ps1
...
Write-Host "Testing V-206366 standalone..." -ForegroundColor Cyan
