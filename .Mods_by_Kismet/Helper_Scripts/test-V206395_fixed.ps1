# Standalone Test for V-206395
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206395.ps1
...
Write-Host "Testing V-206395 standalone..." -ForegroundColor Cyan
