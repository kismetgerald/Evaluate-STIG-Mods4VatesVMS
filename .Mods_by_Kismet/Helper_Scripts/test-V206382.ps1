# Standalone Test for V-206382
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206382.ps1
...
Write-Host "Testing V-206382 standalone..." -ForegroundColor Cyan
