# Standalone Test for V-206354
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206354.ps1
...
Write-Host "Testing V-206354 standalone..." -ForegroundColor Cyan
