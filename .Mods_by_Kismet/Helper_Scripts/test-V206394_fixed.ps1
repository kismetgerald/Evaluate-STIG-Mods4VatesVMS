# Standalone Test for V-206394
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206394.ps1
...
Write-Host "Testing V-206394 standalone..." -ForegroundColor Cyan
