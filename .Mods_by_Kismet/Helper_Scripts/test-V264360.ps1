# Standalone Test for V-264360
# Run from: Evaluate-STIG directory
# Command: pwsh ./.Mods_by_Kismet/Test/test-V264360.ps1
...
Write-Host "Testing V-264360 standalone..." -ForegroundColor Cyan
