# Standalone Test for V-206361
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206361.ps1
...
Write-Host "Testing V-206361 standalone..." -ForegroundColor Cyan
