# Standalone Test for V-264366
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V264366.ps1
...
Write-Host "Testing V-264366 standalone..." -ForegroundColor Cyan
