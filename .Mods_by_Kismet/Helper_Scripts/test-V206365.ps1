# Standalone Test for V-206365
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206365.ps1
...
Write-Host "Testing V-206365 standalone..." -ForegroundColor Cyan
