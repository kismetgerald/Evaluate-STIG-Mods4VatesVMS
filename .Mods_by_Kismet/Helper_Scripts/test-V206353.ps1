# Standalone Test for V-206353
# Run from: Evaluate-STIG directory
# Command: pwsh ./.Mods_by_Kismet/Test/test-V206353.ps1
...
Write-Host "Testing V-206353 standalone..." -ForegroundColor Cyan
