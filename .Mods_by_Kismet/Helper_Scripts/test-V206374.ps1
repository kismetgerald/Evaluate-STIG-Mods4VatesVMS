# Standalone Test for V-206374
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206374.ps1
...
Write-Host "Testing V-206374 standalone..." -ForegroundColor Cyan
