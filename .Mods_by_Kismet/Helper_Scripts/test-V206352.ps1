# Standalone Test for V-206352
# Run from: Evaluate-STIG directory
# Command: pwsh ./.Mods_by_Kismet/Test/test-V206352.ps1
...
Write-Host "Testing V-206352 standalone..." -ForegroundColor Cyan
