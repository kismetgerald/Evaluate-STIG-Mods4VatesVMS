# Standalone Test for V-206381
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206381.ps1
...
Write-Host "Testing V-206381 standalone..." -ForegroundColor Cyan
