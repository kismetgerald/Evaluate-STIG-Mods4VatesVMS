# Standalone Test for V-264362
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V264362.ps1
...
Write-Host "Testing V-264362 standalone..." -ForegroundColor Cyan
