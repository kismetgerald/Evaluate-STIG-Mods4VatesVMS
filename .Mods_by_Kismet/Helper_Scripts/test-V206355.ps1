# Standalone Test for V-206355
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206355.ps1
...
Write-Host "Testing V-206355 standalone..." -ForegroundColor Cyan
