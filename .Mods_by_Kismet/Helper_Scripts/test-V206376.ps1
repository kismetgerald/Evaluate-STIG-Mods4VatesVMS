# Standalone Test for V-206376
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206376.ps1
...
Write-Host "Testing V-206376 standalone..." -ForegroundColor Cyan
