# Standalone Test for V-206360
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206360.ps1
...
Write-Host "Testing V-206360 standalone..." -ForegroundColor Cyan
