# Standalone Test for V-206377
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V206377.ps1
...
Write-Host "Testing V-206377 standalone..." -ForegroundColor Cyan
