# Standalone Test for V-264363
# Run from: Evaluate-STIG directory
# Command: .\.Mods_by_Kismet\Test\test-V264363.ps1
...
Write-Host "Testing V-264363 standalone..." -ForegroundColor Cyan
