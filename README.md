...
| `Scan-XO_GPOS_Debian12_Checks` | GPOS SRG V3R2 | XO (Debian 12) | 198 | :clipboard: **Stub** — all checks return `Not_Reviewed` with auditor guidance (18 CAT I + 170 CAT II + 10 CAT III) |
