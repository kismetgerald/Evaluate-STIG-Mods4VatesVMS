...
| `Scan-XO_ASD_Checks` | ASD STIG V6R4 | Xen Orchestra | 286 | :white_check_mark: **Complete** — all 286 checks automated (34 CAT I + 252 CAT II); EvalScore 43.36% |
| `Scan-XO_GPOS_Debian12_Checks` | GPOS SRG V3R2 | XO (Debian 12) | 198 | :construction: **In Progress** — 38 checks automated (18 CAT I + 19 CAT II + 1 CAT III); 151 CAT II + 9 CAT III remaining |
