...
| Module | STIG / SRG Applied | Target | Checks |
|---|---|---|---|
| `Scan-XO_WebSRG_Checks` | Web Server SRG V4R4 | Xen Orchestra | 126 |
| `Scan-XO_ASD_Checks` | ASD STIG V6R4 | Xen Orchestra | 286 |
| `Scan-XO_GPOS_Debian12_Checks` | GPOS SRG V3R2 | XO (Debian 12) | 198 |
| `Scan-XCP-ng_VMM_Checks` | VMM SRG V2R2 | XCP-ng Dom0 | 204 |
| `Scan-XCP-ng_Dom0_RHEL7_Checks` | RHEL 7 STIG V3R15 (adapted) | XCP-ng Dom0 | 368 |
