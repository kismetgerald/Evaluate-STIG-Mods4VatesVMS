...
| `Scan-XO_ASD_Checks` | ASD STIG V6R4 | Xen Orchestra | 286 | :construction: **In Progress** — 286/286 checks automated (100%); all 34 CAT I + 252 CAT II return definitive status; EvalScore 43.36% |
